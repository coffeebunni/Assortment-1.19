...
public class BaseFeast extends Block {
    ...
    public BaseFeast(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (world.isClient) {
            if (BaseFeast.tryEat(world, pos, state, player).isAccepted()) {
        ...
        return BaseFeast.tryEat(world, pos, state, player);
    }
    ...
    protected static ActionResult tryEat(WorldAccess world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        player.incrementStat(AssortmentStatInit.EAT_FEAST_SLICE);
