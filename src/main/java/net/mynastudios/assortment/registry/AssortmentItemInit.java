...
public class AssortmentItemInit {
    ...
    public static final Item STEEL_HORSE_ARMOR = registerItem("steel_horse_armor",
            new HorseArmorItem(9, "steel", new Item.Settings().maxCount(1).group(AssortmentItemGroup.ASSORTMENT)));
    public static final Item ROSE_GOLD_HORSE_ARMOR = registerItem("rose_gold_horse_armor",
            new HorseArmorItem(8, "rose_gold", new Item.Settings().maxCount(1).group(AssortmentItemGroup.ASSORTMENT)));
    public static final Item NETHERITE_HORSE_ARMOR = registerItem("netherite_horse_armor",
            new HorseArmorItem(13, "netherite", new Item.Settings().maxCount(1).group(AssortmentItemGroup.ASSORTMENT)));
