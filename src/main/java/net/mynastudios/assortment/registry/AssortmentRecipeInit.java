...
public class AssortmentRecipeInit {
    ...
    public static final RecipeSerializer<MillingRecipe> MILLING_RECIPE_SERIALIZER = Registry.register(Registry.RECIPE_SERIALIZER, new Identifier(Assortment.MODID, "milling"), new CookingRecipeSerializer<>(MillingRecipe::new, 200));
